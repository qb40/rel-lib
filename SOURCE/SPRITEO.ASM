...
;SUB RELSPRITEONSPRITE(BYVAL DESTSEG%,BYVAL DESTOFF%,BYVAL X%,BYVAL Y%,BYVAL SPRITESEGMENT%,BYVAL SPRITEOFFSET%)
;STACK
;DEST SEG       =18
;DEST OFF       =16
;X              =14  
...
PUBLIC RELSPRITEONSPRITE
RELSPRITEONSPRITE PROC
